...
var female = require('./genders/female'); // Match gender type from the first name


var getGender = function getGender(firstName, lang) {
...
var getFirstNameFromFullName = function getFirstNameFromFullName(fullName) {
  return fullName.toLowerCase().replace(/^\s+|^0-9+|[^a-z-úñäâàáéèëêïîöôùüûœç\- ]+/g, '').split(/\s/)[0];
}; // Detect gender


exports.detect = function (fullName, lang) {
  var firstName = getFirstNameFromFullName(fullName);
  var resgender = getGender(firstName, lang);
  return resgender;
}; // Export getFirstNameFromFullName function


exports.getFirstName = getFirstNameFromFullName;
},{"./genders/female":1,"./genders/male":2}],4:[function(require,module,exports){
...
},{"./problematic.json":8,"normalize-strings":5,"pluralize":7}],7:[function(require,module,exports){
/* global define */
...
},{"gender-detection":3,"syllable":6}]},{},[9]);
