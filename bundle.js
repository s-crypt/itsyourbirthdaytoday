...
},{"./charmap":1}],3:[function(require,module,exports){
'use strict'
...
},{"./problematic.json":5,"normalize-strings":2,"pluralize":4}],4:[function(require,module,exports){
/* global define */
...
(function () {
  ...
  */
  ...
  function setNameToSay () {
    ...
    console.log('total syllables is ' + totalSyllables)
    if (!hasSpeechSupport) {
      return
    }
